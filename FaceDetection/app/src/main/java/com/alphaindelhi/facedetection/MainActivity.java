package com.alphaindelhi.facedetection;
...
// Face Detection Code.
        ...
        detector.detectInImage(image).addOnSuccessListener(new OnSuccessListener<List<FirebaseVisionFace>>() {
            ...
            public void onSuccess(List<FirebaseVisionFace> firebaseVisionFaces) {
                ...
                if (firebaseVisionFaces.size() == 0){
                    ...
                    bundle.putString(CodingFaceDetection.RESULT_TEXT, resultText);
                    DialogFragment resultDialog = new ResultDialog();
                    resultDialog.setArguments(bundle);
                    resultDialog.setCancelable(false);
                    resultDialog.show(getSupportFragmentManager(), CodingFaceDetection.RESULT_DIALOG);
                }
            }
        });
    ...
    //Face Detection Code finished for MainActivity!
